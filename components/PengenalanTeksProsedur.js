            ...
            <SafeAreaView style={{margin: 24}}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                  ...
                  <View>
                    ...
                    <Text style={{color: '#A5A5A5', textAlign: 'center', marginTop: 4, fontSize: 12, fontWeight: '400'}}>Kaidah Tesk Prosedur</Text>
                  </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{marginTop: 24}}>
                  <View style={{marginBottom: 128}}>
                    ...
                    <Text style={{color: '#131313', fontSize: 16, fontWeight: '600', marginTop: 16}}>Jenis-Jenis Teks Prosedur</Text>
                    <Text style={{textAlign: 'justify', lineHeight: 21, color: '#A5A5A5', fontSize: 12, fontWeight: '400', marginTop: 8}}>Teks prosedur juga ternyata memiliki beberapa jenisnya, lho! Penasaran? Berikut jenis-jenis teks prosedur.</Text>
                    <Text style={{color: '#131313', fontSize: 12, fontWeight: '500', marginTop: 16}}>1. Teks Prosedur Sederhana</Text>
                    <Text style={{textAlign: 'justify', lineHeight: 21, color: '#A5A5A5', fontSize: 12, fontWeight: '400', marginTop: 8}}>Teks prosedur sederhana hanya berisi dua atau tiga langkah saja. Contohnya prosedur untuk mengoperasikan setrika.</Text>
                    <Text style={{color: '#131313', fontSize: 12, fontWeight: '500', marginTop: 16}}>2. Teks Prosedur Kompleks</Text>
                    <Text style={{textAlign: 'justify', lineHeight: 21, color: '#A5A5A5', fontSize: 12, fontWeight: '400', marginTop: 8}}>Teks prosedur kompleks terdiri atas banyak langkah dan jenjang untuk tiap tahapannya. Contohnya prosedur pembayaran tilang oleh polisi.</Text>
                    <Text style={{textAlign: 'justify', lineHeight: 21, color: '#A5A5A5', fontSize: 12, fontWeight: '400', marginTop: 32}}>Jadi, teks prosedur adalah teks yang bertujuan untuk membantu memudahkan pembacanya melakukan langkah kerja secara berurutan untuk mencapai tujuan tertentu atau petunjuk penggunaan. Teks prosedur biasanya ditulis secara berurutan agar memudahkan pengguna mengikuti langkah-langkah secara berurutan.</Text>
                  </View>
                </ScrollView>
            </SafeAreaView>
        </View>
